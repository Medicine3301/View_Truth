...
/*更新cid='C005'的貼文(post)總數post_count*/
update community
set post_count=1
where cid='C005';
/*更新cid='C002' or cid='C004' or cid='C006' or cid='C007' or cid='C008' or cid='C009'的貼文(post)總數post_count*/
update community
set post_count=2
where cid='C002' or cid='C004' or cid='C006' or cid='C007' or cid='C008' or cid='C009';
/*更新cid='C010'的貼文(post)總數post_count*/
update community
set post_count=6
where cid='C010';
/*查詢各個cid總共有幾個貼文*/
select cid,count(cid) as 總貼文
from post
group by cid;
