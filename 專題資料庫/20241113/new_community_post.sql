...
INSERT INTO `post` VALUES ('f8b79c16-f589-41d4-84b3-8e73f6ccb307','P0001','C001','八卦哈哈','測試1','2024-11-13 05:21:07',0,'acrhjh');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `community_post_count` AFTER INSERT ON `post` FOR EACH ROW BEGIN
  UPDATE community
